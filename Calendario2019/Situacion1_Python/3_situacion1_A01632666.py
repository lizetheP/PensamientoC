...
def menuAdulto ():
    print ("1. Pizza $180.00")
    print ("2. Carne asada $200.00")
    print ("3.Salmón $300.00")
...
def menuNino ():
    print ("1. Nuggets de pollo $80.00")
    print ("2. Papas a la francesa $50.00")
    print ("3. Ensalada $40.00")
